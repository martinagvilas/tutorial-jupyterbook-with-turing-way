...
This represents a real shift in how research works and funders are starting to require researchers to make their data available and submit data management plans as part of project proposals (see also our chapter on research data management.
...
The steps below help you make your data findable, accessible, interoperable and reusable (FAIR). You can learn more about FAIR principles in the chapter on research data management.
...
Data privacy is also maintained when dealing with data of national or commercial interest, details for which are listed in the chapter Research Data Management, in the section National and commercially sensitive data.
